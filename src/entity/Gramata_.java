...
@Table(name = "gramata")
@XmlRootElement
@SequenceGenerator(name="gramata_ident_seq")
@NamedQueries({
...
public class Gramata_ {
    ...
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="gramata_ident_seq")
    @Id
    @Column(name = "ident")
    private Long ident;
    @Column(name = "maksa")
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Gramata_)) {
            return false;
        }
        Gramata_ other = (Gramata_) object;
